...
<div class="row mt-2">
	<div class="col-lg-9  rounded p-4">
		<div class="row form-group">
			<h5 class="fw-bold">Select GR date</h5>
			<div class="mt-2 col-lg-5 col-md-12">
				<div class="input-group"> 
					<div class="input-group-text p-0 px-2"> <span class="bi bi-calendar text-dgreen"> </span> </div>
				<input type="text" class="form_datetime form-control form-control-sm input-sm" name="fld_summ_dtefrom" id="fld_summ_dtefrom" placeholder ="From" value="" required autocomplete="off"/>
				</div>
			</div>
			<div class="mt-2 col-lg-5 col-md-12">
				<div class="input-group"> 
					<div class="input-group-text p-0 px-2"> <span class="bi bi-calendar text-dgreen"> </span> </div>
						<input type="text" class="form_datetime form-control form-control-sm input-sm" name="fld_summ_dteto" id="fld_summ_dteto" value="" placeholder ="To" required autocomplete="off"/>
				</div>
			</div>
			<div class="mt-2 col-lg-2">
				<button class="btn btn-dgreen btn-sm"  id="submit_btn_grsumm" type="submit"> <span class="bi bi-search"> </span> Download</button>
...
<script type="text/javascript">
    ...
    $('#submit_btn_grsumm').click(function() {

	        try { 
                
               	var fld_summ_dteto = $('#fld_summ_dteto').val();
				var fld_summ_dtefrom = $('#fld_summ_dtefrom').val();
                
                if(fld_summ_dtefrom > fld_summ_dteto){
                ...
                if(fld_summ_dtefrom === ''){
                 ...
                 //end for
                var smparam = { 
                   	fld_summ_dteto: fld_summ_dteto,
					fld_summ_dtefrom:fld_summ_dtefrom,
                    
                }
                   __mysys_apps.mepreloader('mepreloaderme',true);
                jQuery.ajax({ // default declaration of ajax parameters
                    type: "POST",
                    url: '<?= site_url() ?>gr-summary-dl',
