...
<main id="main">
    ...
    <div class="pagetitle">
        <h1>Total Redemption</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Total Redemption</li>
            </ol>
            </nav>
    </div><!-- End Page Title -->
	...
	<div class="row mb-3 me-form-font">
	    <div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			<h6 class="card-title">Total Redemption</h6>
	    			<?=form_open('me-newapp-cust-save','class="needs-validation" id="myfrms_redempt" ');?>
	    			<div class="row">
	    				<div class="col-lg-12">
			    			<div class="row mb-3">
		...
		<div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<div id="totredemptrecs">
	    				<?php
                       $data = $mymdrpts->totredempt_rec_view(1,20);
                       echo view('mdrpts/md-tot-redempt-recs',$data);
                    ?>	
	    			</div>
	    		</div> <!-- end card-body -->
	        </div>
