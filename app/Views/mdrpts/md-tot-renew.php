...
<main id="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Total Renewal</li>
            </ol>
            </nav>
    </div><!-- End Page Title -->
	...
	<div class="row mb-3 me-form-font">
	    <div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			<h6 class="card-title">Total Renewal</h6>
	    			<?=form_open('me-renew-save','class="needs-validation" id="myfrms_totrenew" ');?>
	    			<div class="row">
	    				<div class="col-lg-12">
			    			<div class="row mb-3">
	    	...
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<div id="totrenewrecs">
                       ...
                       echo view('mdrpts/md-tot-renew-recs',$data);
                    ?>	
	    			</div>
	    		</div> <!-- end card-body -->
	        </div>
