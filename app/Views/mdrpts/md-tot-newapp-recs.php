...
$mytxtsearchrec_tnewapp = $request->getVar('txtsearchedrec');
...
<?=form_open('me-tot-newapp-recs','class="needs-validation-search" id="myfrmsearchrec_tnewapp" ');?>
    <div class="col-md-6 mb-1">
        <div class="input-group input-group-sm">
            <label class="input-group-text fw-bold" for="search">Search:</label>
            <input type="text" id="mytxtsearchrec_tnewapp" class="form-control form-control-sm" name="mytxtsearchrec_tnewapp" placeholder="Search" />
...
<div class="col-md-8">
	<?=$mylibzsys->mypagination($npage_curr,$npage_count,'__myredirected_rsearch_tnewapp','');?>
	</div>

			<div class="table-responsive">
				<div class="col-md-12 col-md-12 col-md-12">
					<table class="table table-striped table-hover table-bordered table-sm" id="tbldata_totnewapp">
						<thead>
							<tr>
								<th>Transaction Number</th>
								<th>Item Description</th>
								<th>Branch</th>
								<th>Total New Application</th>
...
<script type="text/javascript"> 
    ...
    function meSetCellPadding () {
        var metable = document.getElementById ("tbldata_totnewapp");
	...
	function __myredirected_rsearch_tnewapp(mobj) { 
		try { 
			__mysys_apps.mepreloader('mepreloaderme',true);
			var txtsearchedrec = jQuery('#mytxtsearchrec_tnewapp').val();
			...
			type: "POST",
			url: '<?=site_url();?>me-tot-newapp-recs',
	...
	jQuery('#mytxtsearchrec_tnewapp').keypress(function(event) { 
		if(event.which == 13) { 
			...
			try { 
				...
				cache: false,
					success: function(data)  { //display html using divID
							jQuery('#totnewapprecs').html(data);
							__mysys_apps.mepreloader('mepreloaderme',false);
							return false;
					},
					error: function() { // display global error on the menu function
