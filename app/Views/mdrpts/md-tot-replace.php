...
<main id="main">
    ...
    <div class="pagetitle">
        <h1>Total Replacement</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Total Replacement</li>
            </ol>
            </nav>
    </div><!-- End Page Title -->
	...
	<div class="row mb-3 me-form-font">
	    <div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			<h6 class="card-title">Total Replacement</h6>
	    			<?=form_open('me-replace-save','class="needs-validation" id="myfrms_totreplace" ');?>
	    			<div class="row">
	    				<div class="col-lg-12">
			    			<div class="row mb-3">
		...
		<div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<div id="totreplacerecs">
	    				<?php
	                       $data = $mymdrpts->rec_view(1,1);
	                       echo view('mdrpts/md-tot-replace-recs',$data);
	                    ?>	
	    			</div>
	    		</div> <!-- end card-body -->
	        </div>
