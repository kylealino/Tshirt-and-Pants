...
$mytxtsearchrec_trenew = $request->getVar('txtsearchedrec');
...
<?=form_open('me-tot-renew-recs','class="needs-validation-search" id="myfrmsearchrec_trenew" ');?>
    <div class="col-md-6 mb-1">
        <div class="input-group input-group-sm">
            <label class="input-group-text fw-bold" for="search">Search:</label>
            <input type="text" id="mytxtsearchrec_trenew" class="form-control form-control-sm" name="mytxtsearchrec_trenew" placeholder="Search" />
...
<div class="col-md-8">
	<?=$mylibzsys->mypagination($npage_curr,$npage_count,'__myredirected_rsearch_trenew','');?>
	</div>

			<div class="table-responsive">
				<div class="col-md-12 col-md-12 col-md-12">
					<table class="table table-striped table-hover table-bordered table-sm" id="tbldata_totrenew">
						<thead>
							
								<th>Item Description</th>
								<th>Branch</th>
								<th>Total Renewal Application</th>
...
<script type="text/javascript"> 
    ...
    function meSetCellPadding () {
        var metable = document.getElementById ("tbldata_totrenew");
	...
	function __myredirected_rsearch_trenew(mobj) { 
		try { 
			__mysys_apps.mepreloader('mepreloaderme',true);
			var txtsearchedrec = jQuery('#mytxtsearchrec_trenew').val();
			...
			type: "POST",
			url: '<?=site_url();?>me-tot-renew-recs',
	...
	jQuery('#mytxtsearchrec_trenew').keypress(function(event) { 
		if(event.which == 13) { 
