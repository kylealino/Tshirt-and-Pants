...
<main id="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Total Purchased</li>
            </ol>
            </nav>
    </div><!-- End Page Title -->
	...
	<div class="row mb-3 me-form-font">
	    <div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			<h6 class="card-title">Total Purchased</h6>
	    			<?=form_open('me-newapp-cust-save','class="needs-validation" id="myfrms_totpurch" ');?>
	    			<div class="row">
	    				<div class="col-lg-12">
			    			<div class="row mb-3">
		...
		<div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<div id="totpurchrecs">
	    				<?php
                       $data = $mymdrpts->totpurch_rec_view(1,20);
                       echo view('mdrpts/md-tot-purch-recs',$data);
                    ?>	
	    			</div>
	    		</div> <!-- end card-body -->
	        </div>
