...
<?=form_open('me-cust-entry-save-rec','class="needs-validation-search" id="myfrmsearchrec" ');?>
							...
							if($rlist !== ''):
								...
								<tr bgcolor="<?=$bgcolor;?>" <?=$on_mouse;?>>
									<td class="text-center" nowrap>
										<?=anchor('me-customer-profile/?mtkn_trxno=' . $mtkn_trxno, '<i class="bi bi bi-eye-fill"></i>',' class="btn btn-warning p-1 pb-0 mebtnpt1 btn-sm"');?>
...
<script type="text/javascript"> 
	...
	function __myredirected_rsearch(mobj) { 
		try { 
			...
			type: "POST",
			url: '<?=site_url();?>me-cust-entry-save-rec',
