...
?>	
				<tr>
		 			...
		 			<td nowrap="nowrap" data-irb="<?=$row['irb_barcde']?>" data-witb ="<?=$row['witb_barcde']?>" data-srb ="<?=$row['srb_barcde']?>" data-wob="<?=$row['wob_barcde']?>" data-pob="<?=$row['pob_barcde']?>" data-dmg="<?=$row['dmg_barcde']?>" data-bcsrs="<?=$row['barcde_series']?>" ><?=$row['witb_barcde']?></td>
