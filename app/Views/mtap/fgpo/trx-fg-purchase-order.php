...
$formattedDateTime = $txt_tdate . " " . $current_time;
...
<main id="main">
    ...
    <div class="pagetitle">
        <h1>FG Purchase Order</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">FG Purchase Order</li>
            </ol>
            </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row mb-3 me-form-font">
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <?=form_open('me-fg-purchase-save','class="needs-validation" id="myfrms_customer" ');?>
            <div class="row">
              <div class="col-lg-6">
                <div class="row mb-3">
                      <label class="col-sm-3 form-label" for="txt_ponumb">FGPO Transaction No:</label>
                      <div class="col-sm-9">
                  ...
                  <div class="row gy-2 mb-3">
                      ...
                      <div class="col-sm-9">
                          ...
                          <input type="hidden" name="cur_date" id="cur_date" value="<?=$formattedDateTime;?>">
                      </div>
                  </div> <!-- end Card No. -->              
                  <div class="row gy-2 mb-3">
          ...
          <div class="card-body">
            <div class="pt-2 bg-dgreen mt-2"> 
               ...
               <div id="purchlist" class="text-center p-2 rounded-3  mt-3 border-dotted bg-light p-4 ">
                    <?php
                       // $data = $mytrxrmpurch->purch_rec_view(1,20);
...
<script type="text/javascript">
    ...
    $('#mbtn_mn_NTRX').click(function() { 
        ...
        if (userselection == true){
            window.location = '<?=site_url();?>me-fg-po-vw';
         }
        else{
            $.hideLoading();
            return false;
        ...
        jQuery('.mitemcode' ) 
          ...
          .autocomplete({
              ...
              select: function( event, ui ) {
                  ...
                  $('#' + xobjitemconf).val(ui.item.ART_UPRICE);
  ...
  $("#mbtn_mn_Save").click(function(e){
    ...
    //__mysys_apps.mepreloader('mepreloaderme',true);
          ...
          var cur_date = jQuery('#cur_date').val();
      ...
      $.ajax({ 
        type: "POST",
        url: '<?=site_url();?>me-fg-purchase-save',
        context: document.body,
        data: eval(mparam),
        global: false,
        cache: false,
...
function mypo_view_recs(mtkn_whse){ 
    ...
    ajaxRequest = jQuery.ajax({
        url: "<?=site_url();?>me-fg-purchase-view",
        type: "post",
        data: {
            mtkn_whse: mtkn_whse
        }
...
function mypo_view_appr(mtkn_whse){ 
    ...
    ajaxRequest = jQuery.ajax({
        url: "<?=site_url();?>me-rm-purchase-view-appr",
        type: "post",
        data: {
            mtkn_whse: mtkn_whse
        }
