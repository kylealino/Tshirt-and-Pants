                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="main_itemc" name="main_itemc" class="form-control form-control-sm bg-white" value="<?=$main_itemc;?>" readonly/>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="barcode" name="barcode" class="form-control form-control-sm" value="<?=$barcode;?>"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="uom" name="uom" class="form-control form-control-sm bg-white" value="<?=$uom;?>" readonly/>
                                </div>
                            </div>
                            <div class="row mb-3">  
                    ...
                    <div class="row gy-2 mb-3">
                        <div class="col-sm-4">
                            <?php if(!empty($sub_itemc)):?>
                                ...
                                <?=anchor('sub-item-masterdata', '<i class="bi bi-arrow-repeat"></i>',' class="btn btn-dgreen-ol btn-sm" ');?>
                            <?php else:?>
