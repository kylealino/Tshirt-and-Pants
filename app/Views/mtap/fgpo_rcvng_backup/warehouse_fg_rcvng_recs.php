							...
							if($rlist !== ''):
								...
								<tr>
									...
									<td nowrap="nowrap">
										...
										<button title="Upload barcode" onclick="javascript:gr_upld_recs('<?=$row['po_sysctrlno'];?>');"  class=" btn btn-dgreen"  title="View pdf"><i class="bi bi-cloud-upload-fill"></i> Upload </button>
									<?php else: ?>
