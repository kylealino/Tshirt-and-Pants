  ...
  <div class="pagetitle">
      ...
      <nav>
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">RM Receiving</li>
          </ol>
          </nav>
  </div><!-- End Page Title -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                    ...
                    <?php if(!empty($po_sysctrlno)):?>
                      <h5 class="text-start text-dgreen fw-bold"> <span > RM CODE : </span> <?=$po_sysctrlno;?> </h5>
                    ...
                    <div class="table-responsive"> 
                     ...
                     <div class="text-center p-2 rounded-3  mt-4 border-dotted bg-light col-lg-6 offset-lg-3 p-4">
                        <h5><i class="bi bi-info-circle-fill text-dgreen"></i> Processing of RMPO's will display in here.</h5> 
                     </div>
