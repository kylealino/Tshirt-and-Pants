						...
						<tbody>
							...
							if($rlist !== ''):
								...
								foreach($rlist as $row): 
									...
									$txt_mtknr = hash('sha384', $row['fgpack_trxno'] . $mpw_tkn);
								...
								?>
								<tr>
									<td nowrap="nowrap"><?=$row['fgpack_trxno'];?></td>
									...
									<td nowrap="nowrap">
										...
										<button title="Upload barcode" onclick="javascript:gr_upld_recs('<?=$row['fgpack_trxno'];?>');"  class=" btn btn-dgreen"  title="View pdf"><i class="bi bi-cloud-upload-fill"></i> Upload </button>
									<?php else: ?>
							  			<i class="bi bi-dash-lg text-dgreen"> </i>
							  		<?php endif; ?>
									</td>
									<td nowrap="nowrap">
										<button title="View items" class="btn btn-dgreen-ol btn-xs gr-btn-view-items"  data-fgno= "<?=$row['fgpack_trxno'];?>" value="<?=$txt_mtknr?>" type="button" ><i class="bi bi-eye-fill"></i> View</button>
									</td>
								</tr>
								<?php 
								$nn++;
