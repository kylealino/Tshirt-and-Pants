		...
		<div class="col-md-12 col-md-12 col-md-12">
            ...
            <th>FG Print</th>
              ...
              <?php if($is_processed == '1'):?>
                <?=anchor('rm-prod/?rmap_trxno=' . $rmap_trxno, '<i class="bi bi bi-eye"></i> PRODUCE ',' class="btn btn-dgreen p-1 pb-0 mebtnpt1 btn-sm"');
                ?>
              <?php else:?>
                  -
              <?php endif;?>  
              ...
              <?php if($is_processed == '1'):?>
              <td>
                <button onclick="window.open('<?= site_url().$print ?>?rmap_trxno=<?=$rmap_trxno?>')" class="btn bg-psuccess"> <i class="bi bi-printer"></i> RM Print</button>
              </td>
              <td>
                <button onclick="window.open('<?= site_url().$print ?>?rmap_trxno=<?=$rmap_trxno?>')" class="btn bg-psuccess"> <i class="bi bi-printer"></i> FG Print</button>
              </td>
              <?php endif;?>
