                ...
                <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover table-sm text-center" id="tbl-rm-recs">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th nowrap="nowrap">Available Qty</th>
                                    ...
                                    <tbody id="gwpo-recs">
                                        ...
                                        ?>
                                        <tr>
                                            <td nowrap="nowrap"><input type="text" id="fabric_code" class="form-control text-center form-control-sm mitemcode bg-white" size="10" value="<?=$rdt['rm_code'];?>" disabled></td>
                                            <td nowrap="nowrap"><input type="text" id="fabric_desc" class="form-control text-center form-control-sm bg-white" size="30" value="<?=$rdt['item_desc'];?>" disabled></td>
                                            <td nowrap="nowrap"><input type="text" id="fabric_uom" class="form-control text-center form-control-sm bg-white" size="10" value="<?=$rdt['ART_UOM'];?>" disabled></td>
                                            <td nowrap="nowrap"><input type="text" id="fabric_inv" class="form-control text-center form-control-sm mitemcode bg-white" size="10" value="<?=$rdt['rm_inv'];?>" disabled></td>
                                            ...
                                            <td nowrap="nowrap"><input type="text" id="fabric_qty" class="form-control text-center form-control-sm bg-white thick-border"size="10" onmouseover="javascript:__pack_totals();" onmouseout="javascript:__pack_totals();" onclick="javascript:__pack_totals();"></td>
                                            <td nowrap="nowrap"><input type="text" id="fabric_qty" class="form-control text-center form-control-sm bg-white" size="10" value="<?=$rdt['item_qty'];?>" disabled></td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <?=anchor('rm-outbound', '<i class="bi bi-arrow-repeat"></i>',' class="btn btn-dgreen-ol btn-sm" ');?>
                            <?php endif?>
                        </div>
                    </div>
                </div> 
...
function rm_req_view_recs(mtkn_whse){ 
  ...
  function __pack_totals() { 
    ...
    for(aa = 1; aa < rowCount1; aa++) { 
        ...
        var qty = jQuery(clonedRow).find('input[type=text]').eq(5).val();
...
$("#mbtn_mn_Save").click(function(e){
    try { 
          ...
          for(aa = 1; aa < rowCount1; aa++) { 
                ...
                var minv = jQuery(clonedRow).find('input[type=text]').eq(3).val();
                var mreqqty = jQuery(clonedRow).find('input[type=text]').eq(4).val();
                var mrelease = jQuery(clonedRow).find('input[type=text]').eq(5).val(); 
