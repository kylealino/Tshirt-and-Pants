						...
						<tbody>
							...
							if($rlist !== ''):
								...
								<tr bgcolor="<?=$bgcolor;?>" <?=$on_mouse;?>>
                                    ...
                                    <td nowrap><?=$row['release_qty'];?></td>
                                    <td nowrap><?=$row['rmng_qty'];?></td>
									
                                    <td nowrap>
									<?php if($item_qty != $release_qty):?>
                                        <?=anchor('rm-outbound/?rmap_trxno=' . $rmap_trxno, 'PROCESS',' class="btn btn-dgreen p-1 pb-0 mebtnpt1 btn-sm"');?>
