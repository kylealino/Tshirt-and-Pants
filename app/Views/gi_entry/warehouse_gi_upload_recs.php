...
<div class="table-responsive"> 
	...
	<div class="form-row py-3">
		<button type="button" class="btn bg-dgreen btn-sm" id="btn-central-rcv">Save</button>  
	</div>
	<?php 
		endif;
	?>
   ...
   //check all function
	...
	$('#btn-central-rcv').on('click',function(){
 	...
 	//	$('#btn-central-rcv').prop("disabled",true);
		...
		if(grcount == 0){
			jQuery('#memsgtestent_danger_bod').html('Please select items!');
