...
$pdf->Cell(29,8,'ITEM CODE',1,0,'C','true'); 
$pdf->SetFont('Arial','B',7);
$pdf->Cell(29,8,'BOX CONTENT',1,0,'C','true'); 
$pdf->SetFont('Arial','B',8);
...
$pdf->SetXY(73,34);
$pdf->Cell(20,4,'PALLET 1','T,R,L',0,'C','true'); 
$pdf->Cell(20,4,'PALLET 2',1,0,'C','true'); 
$pdf->Cell(20,4,'PALLET 3',1,0,'C','true');
// $pdf->Cell(20,4,'DUMPING AREA','T,L,R',0,'C','true');
$pdf->Cell(20,4,'PALLET 4',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 5',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 6',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 7',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 8',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 9',1,0,'C','true');
$pdf->Cell(20,4,'PALLET 10',1,0,'C','true');

$pdf->SetXY(73,38); 
$pdf->Cell(10,4,'QTY',1,0,'C','true');
$pdf->Cell(10,4,'SIGN',1,0,'C','true');
$pdf->Cell(10,4,'QTY',1,0,'C','true');
$pdf->Cell(10,4,'SIGN',1,0,'C','true');
$pdf->Cell(10,4,'QTY',1,0,'C','true');
$pdf->Cell(10,4,'SIGN',1,0,'C','true');
...
foreach($q3->getResultArray() as $row){
	...
	for($i = 0; $i < count($item); $i++){
		...
		if($Y < 182){
			...
			$pdf->SetXY(5,$Y); 
			if($_recid != $xrecid){
				$pdf->Cell(29,$yaxis,$_ART_CODE,$border,0,'L'); 
				$pdf->Cell(29,$yaxis,$_ART_DESC,1,0,'L'); 
				$pdf->Cell(10,5,number_format($tboxes,0),$border,0,'C'); 
				// $pdf->Cell(10,5,$convf,1,0,'L'); 
				$pdf->Cell(10,5,'',1,0,'L'); //pallet1 qty
				$pdf->Cell(10,5,'',1,0,'L');  // pallet1 sign
				$pdf->Cell(10,5,'',1,0,'L');  // pallet2 qty
				$pdf->Cell(10,5,'',1,0,'L'); //pallet2 sign
				$pdf->Cell(10,5,'',1,0,'L');  // pallet3 qty
				$pdf->Cell(10,5,'',1,0,'L');  // pallet3 sign
				// $pdf->Cell(20,5,'',1,0,'L');  // dump area
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet4 qty
				$pdf->Cell(10,5,'',$border,0,'L'); //pallet4 sign
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet5 qty
				$pdf->Cell(10,5,'',$border,0,'L'); //pallet5 sign
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet6 qty
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet6 sign
				$pdf->Cell(10,5,'',$border,0,'C');//pallet7 qty
				$pdf->Cell(10,5,'',$border,0,'L'); //pallet7 sign
				$pdf->Cell(10,5,'',$border,0,'C');//pallet8 qty
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet8 sign
				$pdf->Cell(10,5,'',$border,0,'C');//pallet9 qty
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet9 sign
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet10 qty
				$pdf->Cell(10,5,'',$border,0,'C'); //pallet10 sign
...
// 	$pdf->Cell(10,5,number_format($grandTotalPerBox,0),1,0,'C'); 
// 	$pdf->Cell(17,5,'',1,0,'L'); //good receive
// 	$pdf->Cell(20,5,'',1,0,'L');  // damge
// 	$pdf->Cell(20,5,'',1,0,'L');  // variance
// 	// $pdf->Cell(20,5,'',1,0,'L');  // dump area
// 	$pdf->Cell(10,5,number_format($gtw11ov,0),1,0,'C'); //w11-overflow xpctd
// 	$pdf->Cell(10,5,'',1,0,'L'); //w11-overflow actual
// 	$pdf->Cell(10,5,number_format($gtw1g1,0),1,0,'C'); //w1g1 xpctd
// 	$pdf->Cell(10,5,'',1,0,'L'); //w1g1 actual
// 	$pdf->Cell(10,5,number_format($gtw1g2,0),1,0,'C'); //w1g2 xpctd
// 	$pdf->Cell(10,5,'',1,0,'C'); //w1g2 actual
// 	$pdf->Cell(10,5,number_format($gtw2g3,0),1,0,'C');//w2g3 xpctd
// 	$pdf->Cell(10,5,'',1,0,'L'); //w2g3 actual
// 	$pdf->Cell(10,5,number_format($gtw2g4,0),1,0,'C');//w2g4 xpctd
// 	$pdf->Cell(10,5,'',1,0,'C'); //w2g4 actual
// 	$pdf->Cell(10,5,number_format($gtw11g5,0),1,0,'C');//w11g5 xpctd
// 	$pdf->Cell(10,5,'',1,0,'C'); //w11g5actual
// 	$pdf->Cell(10,5,number_format($gtw11g6,0),1,0,'C'); //w11g6 xpctd
// 	$pdf->Cell(10,5,'',1,0,'C'); //w11g6 actual
