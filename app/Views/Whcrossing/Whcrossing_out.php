                    ...
                    <div class="card">
                      ...
                      <div class="row card-body">
                        <div class="col-lg-4 offset-lg-4 mt-2">
                          ...
                          <div class="row mb-2 ">
                             <label for="control-number" class="text-center text-dgreen p-2">SELECT JO</label>
                            <div class="input-group"> 
                              <div class="input-group-text text-dgreen">
                                <i class=" bi bi-search"></i>
                              </div>
                              <input type="text" class="form-control form-control-sm " id="control-number" placeholder="Control number">
                              <div class="input-group-prepend">
                                <button class="btn btn-dgreen rounded-0 rounded-end">Search </button>
                              </div>
                            </div>
                          </div>
                          </form>
...
function crossingmain_view_recs(mtkn_arttr){ 
    ...
    ajaxRequest = jQuery.ajax({
        url: "<?=site_url();?>whcrossing-outpl-recs",
        type: "post",
        data: {
