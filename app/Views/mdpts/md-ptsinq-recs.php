...
$mytxtsearchrec_tptsinq = $request->getVar('txtsearchedrec');
...
<?=form_open('me-points-inq-recs','class="needs-validation-search" id="myfrmsearchrec_tptsinq" ');?>
    <div class="col-md-6 mb-1">
        <div class="input-group input-group-sm">
            <label class="input-group-text fw-bold" for="search">Search:</label>
            <input type="text" id="mytxtsearchrec_tptsinq" class="form-control form-control-sm" name="mytxtsearchrec_tptsinq" placeholder="Search" />
...
<div class="col-md-8">
	<?=$mylibzsys->mypagination($npage_curr,$npage_count,'__myredirected_rsearch_tptsinq','');?>
	</div>

			<div class="table-responsive">
				<div class="col-md-12 col-md-12 col-md-12">
					<table class="table table-striped table-hover table-bordered table-sm" id="tbldata_totptsinq">
						<thead>
...
<script type="text/javascript"> 
    ...
    function meSetCellPadding () {
        var metable = document.getElementById ("tbldata_totptsinq");
	...
	function __myredirected_rsearch_tptsinq(mobj) { 
		try { 
			__mysys_apps.mepreloader('mepreloaderme',true);
			var txtsearchedrec = jQuery('#mytxtsearchrec_tptsinq').val();
			...
			type: "POST",
			url: '<?=site_url();?>me-points-inq-recs',
	...
	jQuery('#mytxtsearchrec_tptsinq').keypress(function(event) { 
		if(event.which == 13) { 
			...
			try { 
				...
				cache: false,
					success: function(data)  { //display html using divID
							jQuery('#totptsinqrecs').html(data);
							__mysys_apps.mepreloader('mepreloaderme',false);
							return false;
					},
					error: function() { // display global error on the menu function
