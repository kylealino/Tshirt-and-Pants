...
$mytxtsearchrec_lost = $request->getVar('txtsearchedrec');
...
<?=form_open('me-tagcard-rec','class="needs-validation-search" id="myfrmsearchrec" ');?>
    <div class="col-md-6 mb-1">
        <div class="input-group input-group-sm">
            ...
            <input type="text" id="mytxtsearchrec_lost" class="form-control form-control-sm" name="mytxtsearchrec_lost" placeholder="Search" value="<?=$mytxtsearchrec_lost?>" />
...
<div class="col-md-8">
	<?=$mylibzsys->mypagination($npage_curr,$npage_count,'__myredirected_rsearch_lost','');?>
	</div>
			...
			<div class="table-responsive">
				<div class="col-md-12 col-md-12 col-md-12">
					<table class="table table-striped table-hover table-bordered table-sm" id="tbldata_cust">
						<thead>
							<tr>
								<th class="text-center"> <i class="bi bi bi-gear-fill"></i>
								</th>
								<th>Card No</th>
							...
							if($rlist !== ''):
								...
								<tr bgcolor="<?=$bgcolor;?>" <?=$on_mouse;?>>
									<td class="text-center" nowrap>
										<button title="Tag as Lost" class="btn btn-primary p-1 pb-0 mebtnpt1 btn-sm" onclick="manual_tag('<?=$row['CUST_NO']?>','L')" >
