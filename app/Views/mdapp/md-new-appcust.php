	    ...
	    <div class="col-md-12">
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<?=form_open('me-newapp-cust-save','class="needs-validation" id="myfrms_customer" ');?>
	    			<div class="row">
	    				<div class="col-lg-6">
			    			<div class="row mb-3">
					            <label class="col-sm-3 form-label" for="mcustacctno">Account Number.</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustacctno" name="mcustacctno" class="form-control form-control-sm" value="<?=$CUST_ACCTNO;?>" required/>
					        ...
					        <div class="row mb-3">
					            ...
					            <div class="col-sm-9">
					                <input type="text" id="mcustcardno" name="mcustcardno" class="form-control form-control-sm" value="<?=$CUST_NO;?>" required/>
					            </div>
					        </div> <!-- end Card No. -->
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustemail">e-Mail</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustemail" name="mcustemail" class="form-control form-control-sm" value="<?=$CUST_EMAIL;?>" required/>
					            </div>
					        </div> <!-- end Card No. -->			        
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustlname">Last Name</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustlname" name="mcustlname" class="form-control form-control-sm" value="<?=$CUST_LNAME;?>" required/>
					            </div>
					        </div> <!-- end Last Name -->			        
					        ...
					        <div class="row gy-2 mb-3">
					            ...
					            <div class="col-sm-9">
					                <input type="text" id="mcustfname" name="mcustfname" class="form-control form-control-sm" value="<?=$CUST_FNAME;?>" required/>
					            </div>
					        </div> <!-- end First Name -->			        
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustmname">Middle Name</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustmname" name="mcustmname" class="form-control form-control-sm" value="<?=$CUST_MNAME;?>" required/>
					            </div>
					        </div> <!-- end Middle Name -->			        
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustcontnum">Contact Numer</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustcontnum" name="mcustcontnum" class="form-control form-control-sm" value="<?=$CUST_CONTNO;?>" required/>
					            </div>
					        </div> <!-- end Contact Numer-->			        
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustbdate">Birth Date</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustbdate" name="mcustbdate" class="form-control form-control-sm meform_date" value="<?=$CUST_BDATE;?>" placeholder="mm/dd/yyyy" required/>
					            </div>
					        </div> <!-- end Birth Date-->	
					        <div class="row gy-2 mb-3">
								...
								<div class="col-sm-9">
									...
									<?= $mylibzsys->mypopulist_2($amcustcivils,$CUST_CIVILS,'mcustcivils','class="form-control form-control-sm" ','','');?>
								</div>
					    ...
					    <div class="col-lg-6">		        
							<div class="row gy-2 mb-4">
								...
								<div class="col-sm-9">
									...
									<?= $mylibzsys->mypopulist_2($amcustgendr,$CUST_GENDER,'mcustgendr','class="form-control form-control-sm" ','','');?>
								</div>
							</div> <!-- end Gender -->
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustaddr1">Address 1</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustaddr1" name="mcustaddr1" class="form-control form-control-sm" value="<?=$CUST_ADDR1;?>" placeholder="House No. / Street" required/>
					            </div>
					        </div> <!-- end Address 1 -->			        					
					        <div class="row gy-2 mb-3">
					            <label class="col-sm-3 form-label" for="mcustaddr2">Address 2</label>
					            <div class="col-sm-9">
					                <input type="text" id="mcustaddr2" name="mcustaddr2" class="form-control form-control-sm" value="<?=$CUST_ADDR2;?>" placeholder="Village / Subdivisions" />
					            </div>
					        </div> <!-- end Address 2 --> 
							<div class="row gy-2 mb-3">
								<label class="col-sm-3 form-label" for="region">Region</label>
								<div class="col-sm-9">
									<input data-id-reg="<?=$reg_code;?>" data-id-reg-code="<?=$CUST_REG;?>" type="text" id="region" name="region" class="form-control form-control-sm" value="<?=$reg_name;?>" placeholder="Region" required/>
								</div>
							</div> <!-- end Region -->
							<div class="row gy-2 mb-3">
								<label class="col-sm-3 form-label" for="province">Province</label>
								<div class="col-sm-9">
									<input data-id-prov="<?=$prov_code;?>" data-id-prov-code="<?=$CUST_PROV;?>" type="text" id="province" name="province" class="form-control form-control-sm" value="<?=$prov_name;?>" placeholder="Province" required/>
								</div>
							</div> <!-- end Province -->
							<div class="row gy-2 mb-3">
								<label class="col-sm-3 form-label" for="city">City / Municipality</label>
								<div class="col-sm-9">
									<input data-id-mun="<?=$cssmun_code;?>" data-id-mun-code="<?=$CUST_CITY;?>" type="text" id="city" name="city" class="form-control form-control-sm" value="<?=$cssmun_name;?>" placeholder="City / Municipality" required/>
								</div>
							</div> <!-- end City -->
							<div class="row gy-2 mb-3">
								<label class="col-sm-3 form-label" for="barangay">Barangay</label>
								<div class="col-sm-9">
									<input data-id-bgy-code="<?=$CUST_BGY;?>" type="text" id="barangay" name="barangay" class="form-control form-control-sm" value="<?=$bgy_name;?>" placeholder="Barangay" required/>
							...
							<div class="row gy-2 mb-3">
								...
								<div class="col-sm-9">
									<input type="text" id="zip_code" name="zip_code" class="form-control form-control-sm" value="<?=$CUST_ZIP;?>" placeholder="Zip Code" required/>
	    	...
	    	<div class="card">
	    		<div class="card-body">
	    			...
	    			<div id="custlist">
                       ...
                       echo view('mdapp/md-new-appcust-recs',$data);
                    ?>	
	    			</div>
	    		</div> <!-- end card-body -->
	        </div>
