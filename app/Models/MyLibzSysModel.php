...
class MyLibzSysModel extends Model
{
            ...
            <div class=\"modal-dialog modal-dialog-centered\">
                <div class=\"modal-content\">
                    <div class=\"modal-header\">
                        <h6 class=\"modal-title\" id=\"staticBackdrop{$domid}\">{$ctitle}</h6>
    ...
    public function memsgbox1($domid,$ctitle='',$cmsg='',$bgcolor="bg-primary") {
        $chtml = "
        <div class=\"modal fade\" id=\"{$domid}\" data-bs-backdrop=\"static\" data-bs-keyboard=\"false\" tabindex=\"-1\" aria-labelledby=\"staticBackdrop{$domid}\" aria-hidden=\"true\">
            <div class=\"modal-dialog\">
                <div class=\"modal-content\">
                    <div class=\"modal-header {$bgcolor} p-1\">
                        <h6 class=\"modal-title fw-bolder\" id=\"staticBackdrop{$domid}\" style=\"color: white !important;\">{$ctitle}</h6>
                        <button type=\"button\" class=\"btn-close btn-sm\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button>
                    </div>
                    <div class=\"modal-body pb-1\" id=\"{$domid}_bod\">
                        {$cmsg}
                    </div>
                </div>
            </div>
    ...
    public function memsgbox2($domid,$ctitle='',$cmsg='',$bgcolor="bg-primary",$modal_size = "") {
        $chtml = "
        <div class=\"modal fade\" id=\"{$domid}\" data-bs-backdrop=\"static\" data-bs-keyboard=\"false\" tabindex=\"-1\" aria-labelledby=\"staticBackdrop{$domid}\" aria-hidden=\"true\">
