...
class MyLibzDBModel extends Model
{
    ...
    public function mysys_user() { 
        $session = session();
        return $session->get('__xsys_myusernrc__');
    }   
    ...
    public function msys_is_logged() { 
        $session = session();
        return $session->get('__xsys_myusernrc_is_logged__');
    }
    ...
    public function mysys_userrema() { 
        $session = session();
        return $session->get('__xsys_myusernrcrema__');
    }
    public function mysys_usergrp(){ 
        $session = session();
        return $session->get('__xsys_myusernrcgroup__');
    }  

    public function mysys_userlvl() { 
        $session = session();
        return $session->get('__xsys_myusernrclevel__');
    }
    public function mysys_user_fullname() { 
        $session = session();
        return $session->get('__xsys_myusernrcpfullname__');
    }     
